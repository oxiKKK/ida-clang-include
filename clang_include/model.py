...
class Profile:
    ...
    idaclang_tilname: str = ""
    idaclang_tildesc: str = ""
    idaclang_macros_path: str = ""
    idaclang_smptrs: str = ""
    idaclang_mangle_format: str = ""
    idaclang_opaqify_objc: bool = False
    idaclang_extra_c_mangling: bool = False
    idaclang_parse_static: bool = False
    idaclang_log_warnings: bool = False
    idaclang_log_ast: bool = False
    idaclang_log_macros: bool = False
    idaclang_log_predefined: bool = False
    idaclang_log_udts: bool = False
    idaclang_log_files: bool = False
    idaclang_log_argv: bool = False
    idaclang_log_target: bool = False
    idaclang_log_all: bool = False
